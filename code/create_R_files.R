...
global_path <- '/Users/Sofia/Desktop/Stanford/Autumn 2017/CS224W/cs224w-uber-movement/data'
# global_path <- './data'
...
sapply(1:24, function(hod) create_textfiles('washington', '2016', '1', hod, 2500))
